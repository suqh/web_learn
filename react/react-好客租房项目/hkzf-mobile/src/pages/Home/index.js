...
/**
 * 问题：点击首页导航菜单，导航到列表页面是，找房菜单没有高亮
 * 原因：原来我们实现该功能的时候，只考虑了 点击以及第一次加载Home组件的情况。但是，我们没有考虑不重新加载Home组件时 的路由切换，因为，这种情况下，
 * 我们的代码没有覆盖到
 * 
 * 解决：
 *   思路：在 路由切换时 也执行 菜单高亮的 逻辑代码
    ...
    return <div className="home">
      ...
      {/* TabBar */}
        <TabBar
          ...
          tintColor="#21b97a"
          barTintColor="white" noRenderContent={true}>
