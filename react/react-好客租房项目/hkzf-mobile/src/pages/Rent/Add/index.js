...
export default class RentAdd extends Component {
  ...
  addHouse = async () => {
    ...
    { tempSlides, title, description, oriented, supporting, price, roomType, size, floor, community: community.id, houseImg })
      ...
      <div className={styles.root}>
        ...
        >
          <InputItem
            ...
            value={title} onChange={val => this.getValue('title', val)}
          />
        </List>
        ...
        >
          <TextareaItem
            ...
            autoHeight
            value={description} onChange={val => this.getValue('description', val)}
          />
        </List>
